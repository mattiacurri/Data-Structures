...
private:
    void checkSubTree(BinTree_pt<T> &BT, BinTree_pt<T> &subBT, typename BinTree_pt<T>::node n,
                      typename BinTree_pt<T>::node subR, bool &isSubTree);
};
...
template<class T>
void subTree<T>::checkSubTree(BinTree_pt<T> &BT, BinTree_pt<T> &subBT, typename BinTree_pt<T>::node n,
                              typename BinTree_pt<T>::node subR, bool &isSubTree) {
    if (isSubTree) {
